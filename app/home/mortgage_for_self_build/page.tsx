...
export default function MortgageForSelfBuild() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-start py-20 relative overflow-hidden bg-[#f4f6f9]">
      ...
      {/* שכבת אור רכה */}
      <div className="absolute bg-linear-to-br left-1/2 -translate-x-1/2 w-300 h-150 bg-white/40 blur-3xl rounded-full opacity-40" />
      ...
      <div className="relative z-10 w-[90%] max-w-4xl bg-white/70 backdrop-blur-xl rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.08)] p-10 md:p-14 transition-transform hover:-translate-y-1">
        ...
        <div className="space-y-8">
          ...
          <div className="font-open-sans font-normal bg-linear-to-r from-blue-50 to-blue-100 p-6 rounded-xl shadow-md hover:shadow-lg transition">
            <h2 className="font-open-sans font-normal text-2xl  text-blue-600 mb-2">
              מהי משכנתא לבניה עצמית?
            </h2>
          ...
          <div className="font-open-sans font-normal bg-linear-to-r from-purple-50 to-purple-100 p-6 rounded-xl shadow-md hover:shadow-lg transition">
