...
//   endDate: string;
//   monthlyPayment: number;
//   loanType: number; // ערך מספרי במקום טקסט
//   showSchedule: boolean;
// }
...
//         endDate: "",
//         monthlyPayment: 0,
//         loanType: loanTypes[0].code, // הגדרת סוג ההלוואה הראשון
//         showSchedule: false, // הוספת שדה
//       },
//     ]);
//   };
...
//             field === "annualInterestRate" ||
//             field === "months" ||
//             field === "endDate") && // שדה endDate התווסף כאן
//           updatedRow.loanAmount > 0 &&
//           updatedRow.monthlyInterestRate > 0 &&
//           updatedRow.months > 0
//         ) {
...
//                   <select
//                     className="w-full border rounded px-2 py-1"
//                     value={row.loanType} // כאן יישמר ה-code
//                     onChange={(e) => updateRow(row.id, "loanType", parseInt(e.target.value))}
//                   >
//                     {loanTypes
//                       .sort((a, b) => a.code - b.code) // מיון לפי code
//                       .map((type) => (
//                         <option key={type.code} value={type.code}>
//                           {type.name}
//                         </option>
