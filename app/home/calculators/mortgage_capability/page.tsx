            ...
            <h2 className="text-white text-2xl font-bold mb-8 text-center">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 [&_label]:text-white   ">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ">
                  <div>
                    <label htmlFor="mortgagePurpose" className="block text-white font-semibold mb-2">מטרת המשכנתא</label>
                    <select
              ...
              {errors.mortgagePurpose && (<p className="text-red-500 text-sm mt-0 w-full">{errors.mortgagePurpose}</p>)}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <p className="text-white font-semibold mb-2">האם יש בן/בת זוג או שותף?</p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
                  ...
                  {formData.hasPartner === 'yes' && (
                    <div>
                      <label htmlFor="spouseAge" className="block text-white font-semibold mb-2">גיל בן/בת זוג</label>
                      <input
                        type="number"
                        name="spouseAge"
                        id="spouseAge"
                ...
                <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
                  ...
                  {formData.hasPartner === 'yes' && (
                    <div>
                      <label htmlFor="spouseMonthlyIncome" className="block text-white font-semibold mb-2">בן/בת זוג </label>
                      <input
                        type="text"
                ...
                <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
                  <div className="flex flex-col justify-between">
                    ...
                    <p className="text-xs text-white mb-1">(הכנסה חודשית כמו שכירות שמתקבלת קצבה קבועה וכיו"ב)</p>
                    <input
                      type="text"
                  ...
                  {formData.hasPartner === 'yes' && (
                    <div className="flex flex-col justify-between">
                      <label htmlFor="spouseAdditionalIncome" className="block text-white font-semibold mb-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
                  <div className="flex flex-col justify-between">
                    ...
                    <p className="text-xs text-white mb-1">(סכום חודשי שמשולם להלוואות עד 18 חודשים)</p>
                    <input
                      type="text"
                      name="hasLongLoans"
                      id="hasLongLoans"
                  ...
                  {formData.hasPartner === 'yes' && (
                    <div className="flex flex-col justify-between">
                      <label htmlFor="spouseHasLongLoans" className="block text-white font-semibold mb-2">
                        בן/בת זוג
                      </label>
                      <p className="text-xs text-white mb-1">(סכום חודשי שמשולם להלוואות עד 18 חודשים)</p>
                      <input
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="equity" className="block text-white font-semibold mb-2">הון עצמי (₪)</label>
                    <input
                      type="text"
                      name="equity"
                      id="equity"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label htmlFor="loanMonths" className="block text-white font-semibold mb-2">מספר חודשי הלוואה</label>
                    <input
                    type="number"
                    name="loanMonths"
                    id="loanMonths"
              ...
              {/* שורה 10: ריבית   */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="annualInterest" className="block text-white font-semibold mb-2">ריבית שנתית</label>
