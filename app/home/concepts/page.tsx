...
const GlossaryPage: React.FC = () => {
  ...
  return (
    <div className=" font-open-sans font-normal min-h-screen bg-[#f4f6f9] text-gray-900  px-4 py-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6 relative">
         ...
         <div className="w-full sm:w-1/2 relative">
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-main text-white bg-[#00bcd4] hover:bg-[#166089] transition-all"
            aria-pressed={sortAZ}
          >
            מיון לפי א-ב {sortAZ ? "🔽" : "🔼"}
          </button>
