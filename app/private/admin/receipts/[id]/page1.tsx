      ...
      <div ref={receiptRef} className="bg-white p-6 shadow-md">
        <div className="flex justify-between items-start border-b border-gray-400 pb-4 mb-4">
          ...
          <div className="text-right text-gray-700 ml-auto">
              <p className="text-2xl font-bold" style={{ lineHeight: '1.2' }}>מורגי משכנתאות</p>
              <p style={{ lineHeight: '0.9' }}>ע.פ: 028979896</p>
              <p style={{ lineHeight: '0.9' }}>טלפון: 052-3684844</p>
              <p style={{ lineHeight: '0.9' }}>אימייל: guycoh@outlook.co.il</p>
              <p style={{ lineHeight: '0.9' }}>כתובת: שמואל הנגיד 6, רמת השרון</p>
           </div>
        </div>
