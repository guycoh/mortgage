  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white shadow-md rounded-lg border border-gray-300 text-right">
      ...
      <div className="mt-6 space-y-4 print:hidden">
        <button onClick={generatePDF} disabled={pdfLoading} className="w-full bg-red-600 text-white py-2 rounded-lg hover:bg-red-700 disabled:bg-red-300 transition-colors duration-200">
