...
// simplified original glyphs (brand colour + a distinctive simple form) drawn
// from each bank's real logo — enough to recognise a bank at a glance in a
// dense ledger row. Leumi is the quality benchmark the rest follow.
