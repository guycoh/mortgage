...
const MenuPage = () => {
  return (
    <div className="bg-gradient-to-r from-white to-[#f8f8f8] min-h-screen flex flex-col justify-center items-center py-10">
