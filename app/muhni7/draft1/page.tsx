...
const ContactPage = () => {
  return (
    <>
     ...
     <div className="flex flex-col items-center min-h-screen py-5 justify-center gap-9 bg-gray-300">
      <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2  grid-cols-1 gap-20 sm:px-24 px-8 items-center">
        ...
        <div className="flex justify-center">
          <a
            href="#_"
            className="group relative inline-flex items-center justify-center overflow-hidden rounded-xl border-2 border-[#A47786] p-4 px-5 py-2.5 font-medium text-[#C4DFE6] shadow-md transition duration-300 ease-out"
          >
            ...
            <span className="absolute flex h-full w-full transform items-center justify-center text-[#A47786] transition-all duration-300 group-hover:translate-y-full">
              Button
            </span>
        ...
        {/* Button 10 */}
        <div className="flex justify-center">
          <button className="group relative h-12 w-32 sm:w-28 rounded-lg border border-[#bc2a8d] bg-white p-1.5 text-base text-[#bc2a8d] duration-500 hover:bg-[#bc2a8d]">
            <p className="absolute top-2.5 left-5 m-0 p-0 duration-500 group-hover:left-2 group-hover:text-white">
              Follow US
            </p>
            <span className="absolute top-3.5 right-2 m-0 h-4 p-0 opacity-0 duration-500 group-hover:text-white group-hover:opacity-100">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
