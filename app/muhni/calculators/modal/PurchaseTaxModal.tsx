...
interface PurchaseTaxModalProps {
  isPurchaseTaxModalOpen: boolean;
  onClose: () => void;
}

const PurchaseTaxModal = ({
  isPurchaseTaxModalOpen,
  onClose,
}: PurchaseTaxModalProps) => {
  ...
  if (!isPurchaseTaxModalOpen) return null;

  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
      <div className="bg-[#f9fafb] backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto border border-gray-200 relative p-6 sm:p-8">
        {/* כפתור סגירה */}
        <button
          onClick={onClose}
...
export default PurchaseTaxModal;
