...
// /aa101test with no lead — the same simulator, on a blank board.
//
...
// different boards. The lead now lives in the path (/aa101test/3) and nowhere
...
export default function Aa100TestPage() {
  ...
  useEffect(() => {
    ...
    if (Number.isFinite(id) && id > 0) router.replace(`/aa101test/${id}`);
  }, [router]);
