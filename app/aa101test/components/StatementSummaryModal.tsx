      ...
      >
        ...
        <div className="ink-cs min-h-0 flex-1 overflow-y-auto">
          <section className="ink-cs-group">
            <h3 className="ink-cs-title" style={{ ["--fam" as string]: "#4a4691" }}>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="ink-cs-meta">
                      ...
                      {r.rate !== null && (
                        <>
                          {" · "}
                          <span className={r.dear ? "ink-cs-warn" : undefined}>ריבית {r.rate.toFixed(2)}%</span>
                        </>
                      )}
                      ...
                      {r.late && <span className="ink-cs-warn"> · בפיגור</span>}
                    </div>
                  </div>
          ...
          <section className="ink-cs-group">
            <h3 className="ink-cs-title" style={{ ["--fam" as string]: "#0d8b9b" }}>
              אם תרצו לסלק את המשכנתא היום
            </h3>
            <div className="ink-facts" style={{ padding: "6px 2px 2px" }}>
              <div>
                <div className="ink-cs-foot-cap">סכום לסילוק מלא</div>
                <Money value={a.totals.payoff} size={19} weight={800} />
              </div>
              <div>
                <div className="ink-cs-foot-cap">מזה עמלת פירעון מוקדם</div>
                <Money
              ...
              {a.freeToBreak.length > 0 && (
                <div>
                  <div className="ink-cs-foot-cap">ניתן להזיז בלי עמלה</div>
                  <Money
        ...
        <footer className="ink-cs-foot">
          <div>
            <div className="ink-cs-foot-cap">יתרת המשכנתא</div>
