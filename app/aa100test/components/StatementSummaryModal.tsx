      ...
      >
        ...
        <div className="fin-cs min-h-0 flex-1 overflow-y-auto">
          <section className="fin-cs-group">
            <h3 className="fin-cs-title" style={{ ["--fam" as string]: "#6b53d8" }}>
          ...
          <section className="fin-cs-group">
            <h3 className="fin-cs-title" style={{ ["--fam" as string]: "#0d8b9b" }}>
              אם תרצו לסלק את המשכנתא היום
            </h3>
            <div className="fin-facts" style={{ padding: "6px 2px 2px" }}>
              <div>
                <div className="fin-cs-foot-cap">סכום לסילוק מלא</div>
                <Money value={a.totals.payoff} size={19} weight={800} />
              </div>
              <div>
                <div className="fin-cs-foot-cap">מזה עמלת פירעון מוקדם</div>
                <Money
              ...
              {a.freeToBreak.length > 0 && (
                <div>
                  <div className="fin-cs-foot-cap">ניתן להזיז בלי עמלה</div>
                  <Money
        ...
        <footer className="fin-cs-foot">
          <div>
            <div className="fin-cs-foot-cap">יתרת המשכנתא</div>
