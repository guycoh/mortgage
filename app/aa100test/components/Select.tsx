          ...
          <AnimatePresence>
            {open && pos && (
              <motion.div
                ...
                role="listbox"
                aria-label={ariaLabel}
                className="fin-pop fin-scroll fin-vars"
                style={{ top: pos.top, left: pos.left, minWidth: pos.width, maxHeight: 276 }}
              ...
              >
                {options.map((o, i) => (
                  ...
                  >
                    ...
                    {o.value === value && (
                      <Check size={13} weight="bold" className={o.note ? "fin-sel-check !ms-1.5" : "fin-sel-check"} />
                    )}
                  </button>
                ))}
              </motion.div>
