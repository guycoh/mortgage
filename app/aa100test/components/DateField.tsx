...
export default function DateField({
  ...
  return (
    <div ref={wrapRef} className="fin-well relative" data-dirty={undefined}>
      <input
        ref={inputRef}
        className="fin-cell pe-7"
          ...
          <AnimatePresence>
            {open && pos && (
              <motion.div
                ref={popRef}
                dir="rtl"
                className="fin-pop fin-cal fin-vars"
              ...
              >
                <div className="fin-cal-head">
                  ...
                  <button className="fin-cal-nav" onClick={() => shiftMonth(-1)} aria-label="חודש קודם" type="button">
                  ...
                  <button className="fin-cal-nav" onClick={() => shiftMonth(1)} aria-label="חודש הבא" type="button">
                ...
                <div className="fin-cal-grid">
                  {HE_DOW.map((d) => (
                    <div key={d} className="fin-cal-dow">
                      {d}
                    </div>
                  ))}
                  {cells.map(({ date, out }) => (
                ...
                <div className="fin-cal-foot">
                  <button className="fin-btn fin-btn-sm" type="button" onClick={() => pick(today)}>
                    היום
                  </button>
                  <button
                  ...
                  <span className="fin-cal-hint">{hint ?? "אפשר גם להקליד dd/mm/yyyy"}</span>
                </div>
              </motion.div>
            )}
          </AnimatePresence>,
